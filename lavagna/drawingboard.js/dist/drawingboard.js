...
DrawingBoard.Control.Navigation = DrawingBoard.Control.extend({
	...
	initialize: function() {
		var el = '';
		if (this.opts.back) el += '<button class="drawing-board-control-navigation-back"><img src="drawingboard.js/img/back.png"  alt=""/></button>';
		if (this.opts.forward) el += '<button class="drawing-board-control-navigation-forward"><img src="drawingboard.js/img/forward.png"  alt=""/></button>';
		if (this.opts.reset) el += '<button class="drawing-board-control-navigation-reset"><img src="drawingboard.js/img/refresh.png"  alt=""/></button>';
		this.$el.append(el);
